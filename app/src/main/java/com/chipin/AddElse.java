...
public class AddElse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_new_else);
    ...
    public void addNewPosition(View view) {
        if (!name_field.getText().toString().trim().equals("")
            ...
            Toast.makeText(AddElse.this, R.string.not_enough_input, Toast.LENGTH_SHORT).show(); }
    }
}